...
if [ "$release" -eq 9 ]; then
    software="nginx apache2 apache2-utils apache2-suexec-custom
        ...
        roundcube-mysql roundcube-plugins percona-server-server-5.7 percona-server-common-5.7
        percona-server-client-5.7 postgresql postgresql-contrib phppgadmin phpmyadmin mc
